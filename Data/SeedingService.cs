...
using AulasAspNetCore.Models.Enums;

namespace AulasAspNetCore.Data
{
    public class SeedingService
    {
        private AulasAspNetCoreContext _context;

        public SeedingService(AulasAspNetCoreContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            _context.Seller.AddRange(s1, s1, s3, s4, s5, s6);
